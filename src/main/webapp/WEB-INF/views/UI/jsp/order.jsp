...
<link
	href='<spring:url value="/resource/css/bootstrap.css" htmlEscape="true"/>'
...
<!--theme-style-->
<link
	href='<spring:url value="/resource/css/style.css" htmlEscape="true" />'
	rel='stylesheet' type='text/css' />
<!--//theme-style-->
...
<!--//fonts-->
<!-- start menu -->
<link href="<spring:url value='/resource/css/memenu.css' /> "
	rel="stylesheet" type="text/css" media="all" />
<script type="text/javascript"
	src='<spring:url value="/resource/js/memenu.js" /> '></script>
<script>
	$(document).ready(function() {
		$(".memenu").memenu();
	});
</script>
<script src="<spring:url value='/resource/js/simpleCart.min.js' /> ">
	
</script>
</head>
<body ng-app="cartApp" ng-controller="cartCtrl" ng-init="initCartId('${orderId}')">
	<div class="header">
	...
	<div>
		...
		<div>
			...
			</a> <a href="<c:url value ='/checkoutConfirmation' ></c:url>" class="btn btn-success pull-right"> <span
		...
		<a href="<spring:url value="/home" />" class="btn btn-default"> <span
