		...
		<div class="product-price1">
			<div class="top-sing">
				<div class="col-md-7 single-top">
					<div class="flexslider">
						<ul class="slides">
							<c:forEach items="${product.getImages()}" var="image">
								...
								<li
									data-thumb="<spring:url value='/resource/images/${image.getImageURL()}' /> ">
									<div class="thumb-image">
										<img
											src="<spring:url value='/resource/images/${image.getImageURL()}' /> "
					...
					<!-- FlexSlider -->
					<script
						src="<spring:url value='/resource/js/jquery.flexslider.js' /> "></script>
					<link rel="stylesheet"
						href="<spring:url value='/resource/css/flexslider.css' /> "
				...
				<div class="col-md-5 single-top-in simpleCart_shelfItem">
					<div class="single-para ">
						...
						<a href="#" class="add-cart item_add"
							ng-click="addToCart('${product.productId}')">ADD TO CART</a>
